        ...
        <section>
            <div class="row ">
                <div class="col-9 bordeado ">
                    <div class="m-4">
                        <h1 class = "text-white ">Mis notas</h1>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <a href="#mostrarCursos_1" data-toggle="collapse" aria-controls="mostrarCursos_1" role="button" class="btn fondo btn-md active ImagenUser text-white">Matemáticas Básicas</a>
                                <div class="collapse multi-collapse" id="mostrarCursos_1">
                                    <div class="card card-body">
                                        <div class="row">
                                            <div class="col-4 text-center" id ="Titulo">
                                                <h4>Titulo</h4>
                                                <hr class="borderNotas">
                                            </div>
                                            <div class="col-4 text-center" id ="Porcentaje">
                                                <h4>Porcentaje</h4>
                                                <hr class="borderNotas">
                                            </div>
                                            <div class="col-4 text-center" id = "Nota">
                                                <h4>Nota</h4>
                                                <hr class="borderNotas">
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-success w-100" onclick="agregarNota()">Agregar nota</button>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="NecesitoParaGanar.php" type="submit" class="btn btn-danger w-100">¿Cuanto necesito para ganar?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
