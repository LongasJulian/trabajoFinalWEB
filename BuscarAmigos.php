    ...
    <body class="cuerpo">
        ...
        <section>
            <div class="row">
                <div class="col-9">
                    <div class="m-4">
                        <h1 class = "text-white ">Buscar amigos</h1>
                        <hr>
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <a href="#mostrarBuscar" data-toggle="collapse" aria-controls="mostrarBuscar" role="button" class="btn fondo btn-md active ImagenUser text-white">Buscar amigos</a>
                                <div class="collapse multi-collapse" id="mostrarBuscar">
                                    ...
                                    <div id="carousel-main" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="w-50 ImagenUser">
                                                    <img src="img/Car1.png">
                                                    <h1 class="text-center text-white">Juanito</h1>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="submit" class="btn btn-success ImagenUser">Agregar</button>    
                                                        </div>
                                                        <div class="col-6">
                                                            <button type="submit" class="btn btn-danger ImagenUser">Rechazar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div class="w-50 ImagenUser">
                                                    <img src="img/Car2.png" width="100px">
                                                    <h1 class="text-center text-white">Helena Nito</h1>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="submit" class="btn btn-success ImagenUser">Agregar</button>    
                                                        </div>
                                            ...
                                            <div class="carousel-item">
                                                <div class="w-50 ImagenUser">
                                                    <img src="img/Car3.png" width="100px">
                                                    <h1 class="text-center text-white">Nicola Tesla</h1>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="submit" class="btn btn-success ImagenUser">Agregar</button>    
                                                        </div>
