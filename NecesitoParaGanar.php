    ...
    <body class="cuerpo">
        ...
        <section>
            <div class="row ">
                <div class="col-9">
                    <div class="m-4">
                        <h1 class = "text-white ">¿Cuanto necesito para ganar?</h1>
                        <hr>
                        <div class="row">
                            <div class="col-2">
                            </div>
                            <div class="col-8 bg-light rounded">
                                <p class="text-dark">Ingresa tus notas actuales</p>
                                <hr class="borderNotas">
                                <div class="row">
                                    <div class="col-5">
                                        <div id="misnotas">
                                        <input type="number" class="form-control" placeholder="Nota"><br>

                                        </div>
                                        <button onclick="agregaropcion()" type="submit" class="btn btn-info m-bottom-auto">Agregar Nota</button>
                                    </div>
                                    <div class="col-5" id="misporcentajes">
                                        <input type="number" class="form-control" placeholder="Porcentaje"><br>
                                    </div>
                                    <div class="col-2">
                                        <a href=""><img src="img/cerrar.png" class="w-25 ImagenCerrar"></a>
                                    </div>                  
                                </div>
                                
                                <br>
                                <button onclick="necesito()" type="submit" class="btn btn-info ImagenUser">Calcular nota</button>
                                <br>
                            </div>
                            <div class="col-2">
                            </div>
